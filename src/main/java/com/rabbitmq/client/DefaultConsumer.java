...
/**
 * Convenience class providing a default implementation of {@link Consumer}. We
 * anticipate that most Consumer implementations will subclass this class.
 */
public class DefaultConsumer implements Consumer {
	...
	/**
	 * Stores the most recently passed-in consumerTag - semantically, there should
	 * be only one.
	 * 
