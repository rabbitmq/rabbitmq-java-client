...
public class ValueWriter {
	...
	public final void writeFieldValue(Object value) throws IOException {
		if (value instanceof String) {
			...
			if (decimal.scale() > 255 || decimal.scale() < 0)
				throw new IllegalArgumentException(
						"BigDecimal has too large of a scale to be encoded. " + "The scale was: " + decimal.scale());
			writeOctet(decimal.scale());
			BigInteger unscaled = decimal.unscaledValue();
			// We use 31 instead of 32 (Integer.SIZE) because bitLength ignores the sign
			// bit,
	...
	/**
	 * Public API - call this to ensure all accumulated values are correctly written
