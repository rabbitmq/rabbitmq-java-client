...
public class ValueReader {
	...
	/**
	 * Protected API - Cast an int to a long without extending the sign bit of the
	 * int out into the high half of the long.
	 */
	 ...
	 */
	private static LongString readLongstr(final DataInputStream in) throws IOException {
	...
	/**
	 * Reads a table argument from a given stream. Also called by
	 * {@link ContentHeaderPropertyReader}.
	 */
