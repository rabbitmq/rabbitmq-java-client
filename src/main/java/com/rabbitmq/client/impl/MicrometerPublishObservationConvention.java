 ...
 */
public interface MicrometerPublishObservationConvention extends ObservationConvention<MicrometerPublishContext> {

    @Override
    default boolean supportsContext(Observation.Context context) {
        return context instanceof MicrometerPublishContext;
    }
