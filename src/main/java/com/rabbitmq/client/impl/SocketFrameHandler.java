...
public class SocketFrameHandler implements FrameHandler {
	...
	/**
	 * Write a 0-8-style connection header to the underlying socket, containing the
	 * specified version information, kickstarting the AMQP protocol version
	 * negotiation process.
	 *
	...
	/**
	 * Write a 0-9-1-style connection header to the underlying socket, containing
	 * the specified version information, kickstarting the AMQP protocol version
	 * negotiation process.
	 *
	 * @param major    major protocol version number
	 * @param minor    minor protocol version number
