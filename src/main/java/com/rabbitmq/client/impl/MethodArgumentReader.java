...
/**
 * Parses AMQP wire-protocol {@link Method} arguments from a DataInputStream.
 * Methods on this object are usually called from generated code.
 */
public class MethodArgumentReader {
	...
	private int bits;
	/**
	 * If we are reading one or more bits, keeps track of which bit position we will
	 * read from next. (reading least to most significant order)
	 */
	private int nextBitMask;

	/**
	 * Resets the bit group accumulator variables when some non-bit argument value
	 * is to be read.
	 */
