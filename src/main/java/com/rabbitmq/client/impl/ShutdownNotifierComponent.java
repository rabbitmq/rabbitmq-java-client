...
/**
 * A class that manages {@link ShutdownListener}s and remembers the reason for a
 * shutdown. Both {@link com.rabbitmq.client.Channel Channel}s and
 * {@link com.rabbitmq.client.Connection Connection}s have shutdown listeners.
 */
public class ShutdownNotifierComponent implements ShutdownNotifier {
	...
	/**
	 * When this value is null, the component is in an "open" state. When non-null,
	 * the component is in "closed" state, and this value indicates the
	 ...
	 * @return <code>true</code> if the component is open; <code>false</code>
	 *         otherwise.
	 */
