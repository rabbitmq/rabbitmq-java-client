...
/**
 * Dropwizard Metrics implementation of {@link MetricsCollector}. Note
 * transactions are not supported (see {@link MetricsCollector}. Metrics
 * provides out-of-the-box support for report backends like JMX, Graphite,
 * Ganglia, or plain HTTP. See Metrics documentation for more details.
 *
