...
public class StringRpcServer extends RpcServer {
	...
	/**
	 * Overridden to do UTF-8 processing, and delegate to handleStringCall. If UTF-8
	 * is not understood by this JVM, falls back to the platform default.
	 */
	@Override
	...
	/**
	 * Overridden to do UTF-8 processing, and delegate to handleStringCast. If
	 * requestBody cannot be interpreted as UTF-8 tries the platform default.
	 */
	@Override
