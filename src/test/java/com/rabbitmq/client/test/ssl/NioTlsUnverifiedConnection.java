...
public class NioTlsUnverifiedConnection extends BrokerTestCase {
	...
	// The purpose of this test is to put some stress on client TLS layer
	// (SslEngineByteBufferInputStream to be specific)
	// in an attempt to trigger condition described in
	// https://github.com/rabbitmq/rabbitmq-java-client/issues/317
	// Unfortunately it is not guaranteed to be reproducible
	@Test
	public void largeMessagesTlsTraffic() throws Exception {
		for (int i = 0; i < 50; i++) {
