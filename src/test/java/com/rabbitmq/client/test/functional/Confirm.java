...
public class Confirm extends BrokerTestCase {
	...
	@Test
	public void persistentMandatoryCombinations() throws IOException, InterruptedException, TimeoutException {
	...
	/*
	 * For testQueueDelete and testQueuePurge to be relevant, the msg_store must not
	 * write the messages to disk (thus causing a confirm). I'd manually comment out
	 * the line in internal_sync that notifies the clients.
	 */
	...
	@Test
	public void waitForConfirmsException() throws IOException, InterruptedException, TimeoutException {
	...
	private void publishN(String exchangeName, String queueName, boolean persistent, boolean mandatory)
			throws IOException {
		for (long i = 0; i < NUM_MESSAGES; i++) {
	...
	private void basicRejectCommon(boolean requeue) throws IOException {
		publishN("", "confirm-test-noconsumer", true, false);
	...
	protected void publish(String exchangeName, String queueName, boolean persistent, boolean mandatory)
			throws IOException {
