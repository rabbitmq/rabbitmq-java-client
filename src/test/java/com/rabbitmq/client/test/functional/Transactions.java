...
public class Transactions extends BrokerTestCase {
	...
	private void basicAck(long tag, boolean multiple) throws IOException {
	...
	private long[] publishSelectAndGet(int n) throws IOException {
		for (int i = 0; i < n; i++) {
			basicPublish();
		}
	 ...
	 */
	@Test
	public void commitPublish() throws IOException {
		txSelect();
		basicPublish();
		assertNull(basicGet());
		txCommit();
	 ...
	 */
	@Test
	public void rollbackPublish() throws IOException {
		txSelect();
		basicPublish();
		txRollback();
		assertNull(basicGet());
	 ...
	 */
	@Test
	public void rollbackPublishOnClose() throws IOException {
		txSelect();
		basicPublish();
		closeChannel();
		openChannel();
	 ...
	 */
	@Test
	public void requeueOnClose() throws IOException {
		basicPublish();
		basicPublish();
		txSelect();
		basicGet();
	...
	/*
	 * messages with committed acks are not requeued on channel close, messages that
	 * weren't ack'ed are requeued on close, but not before then.
	 */
	@Test
	public void commitAcks() throws IOException {
		basicPublish();
		basicPublish();
		txSelect();
		basicGet();
	...
	*/
	@Test
	public void commitAcksOutOfOrder() throws IOException {
	...
	/*
	 * rollback rolls back acks and a rolled back ack can be re-issued
	 */
	@Test
	public void rollbackAcksAndReAck() throws IOException {
		basicPublish();
		txSelect();
		basicGet();
		basicAck();
	 ...
	 */
	@Test
	public void unknownTagAck() throws IOException {
		basicPublish();
		txSelect();
		basicGet();
		basicAck();
	 ...
	 */
	@Test
	public void noRequeueOnRollback() throws IOException {
		basicPublish();
		basicPublish();
		txSelect();
		basicGet();
	 ...
	 */
	@Test
	public void autoAck() throws IOException {
		basicPublish();
		txSelect();
		basicGet(true);
		closeChannel();
	 ...
	 */
	@Test
	public void ackAll() throws IOException {
		basicPublish();
		basicPublish();
		txSelect();
		basicGet();
	...
	@Test
	public void nonTransactedCommit() throws IOException {
		try {
			txCommit();
	...
	@Test
	public void nonTransactedRollback() throws IOException {
		try {
			txRollback();
			fail("Expected channel error");
		} catch (IOException e) {
	...
	@Test
	public void redeliverAckedUncommitted() throws IOException {
		txSelect();
		basicPublish();
		txCommit();
		basicGet();
	...
	@Test
	public void commitWithDeletedQueue() throws IOException, TimeoutException {
		txSelect();
		basicPublish();
		releaseResources();
		try {
	...
	@Test
	public void shuffleAcksBeforeRollback() throws IOException {
	...
	private abstract class NackMethod {
		abstract public void nack(long tag, boolean requeue) throws IOException;
	...
	private final NackMethod basicNack = new NackMethod() {
		public void nack(long tag, boolean requeue) throws IOException {
	...
	/*
	 * messages with nacks get requeued after the transaction commit. messages with
	 * nacks with requeue = false are not requeued.
	 */
	public void commitNacks(NackMethod method) throws IOException {
		basicPublish();
		basicPublish();
		txSelect();
		basicGet();
	...
	public void rollbackNacks(NackMethod method) throws IOException {
		basicPublish();
		txSelect();
		basicGet();
		method.nack(true);
	...
	public void commitAcksAndNacks(NackMethod method) throws IOException {
		long tags[] = publishSelectAndGet(3);
		basicAck(tags[1], false);
	...
	@Test
	public void commitNacks() throws IOException {
		commitNacks(basicNack);
	}

	@Test
	public void rollbackNacks() throws IOException {
		rollbackNacks(basicNack);
	}

	@Test
	public void commitAcksAndNacks() throws IOException {
		commitAcksAndNacks(basicNack);
	}

	@Test
	public void commitRejects() throws IOException {
		commitNacks(basicReject);
	}

	@Test
	public void rollbackRejects() throws IOException {
		rollbackNacks(basicReject);
	}

	@Test
	public void commitAcksAndRejects() throws IOException {
