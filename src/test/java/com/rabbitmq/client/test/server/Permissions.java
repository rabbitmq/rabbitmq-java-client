...
public class Permissions extends BrokerTestCase {
	...
	@Test
	public void passiveDeclaration() throws IOException {
	...
	protected void runTest(boolean expC, boolean expW, boolean expR, boolean expN, WithName test) throws IOException {
